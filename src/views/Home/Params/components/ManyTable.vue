<template>
  <el-row>
    <el-col>
      <el-button type="primary" :disabled="goodsStore.isDisable" @click="addParams">添加参数</el-button>
    </el-col>
  </el-row>
  <el-table :data="goodsStore.manyTableData" row-key="attr_id">
...
const modifyHandler = (attr_id, attr_name) => {
  ...
  //   请求所需要的参数
  goodsStore.goodsParams.manyParams = attr_name;
